...
class ChooseSongActivity : TabActivity() {
    ...
    public override fun onCreate(state: Bundle?) {
        ...
        val allFilesIcon =
            BitmapFactory.decodeResource(this.resources, R.drawable.allfilesicon)
        val recentFilesIcon =
            BitmapFactory.decodeResource(this.resources, R.drawable.recentfilesicon)
        val browseFilesIcon =
            BitmapFactory.decodeResource(this.resources, R.drawable.browsefilesicon)
        val tabHost = tabHost
        tabHost.addTab(
            tabHost.newTabSpec("All")
        ...
        tabHost.addTab(
            tabHost.newTabSpec("Recent")
                ...
                .setContent(
                    Intent(
                        this,
                        RecentSongsActivity::class.java
                    ).addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP)
                )
        )
        tabHost.addTab(
            tabHost.newTabSpec("Browse")
    ...
    fun doOpenFile(file: FileUri) {
        ...
        if (data == null || data.size <= 6 || !MidiFile.hasMidiHeader(
                data
            )
        ) {
            showErrorDialog(
        ...
        val intent =
            Intent(Intent.ACTION_VIEW, file.uri, this, SheetMusicActivity::class.java)
