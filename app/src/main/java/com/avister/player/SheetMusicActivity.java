...
public class SheetMusicActivity extends MidiHandlingActivity {
    ...
    public void onCreate(Bundle state) {
        ...
        this.setTitle("avister.player: " + title);
        byte[] data;
        try {
    ...
    private void saveAsImages(String name) {
        ...
        try {
            ...
            for (int page = 1; page <= numpages; page++) {
                ...
                File path = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES + "/avister.player");
